...
| [`lisp-runtime-runner/`](lisp-runtime-runner/README.md) | Opt-in SBCL JSON-RPC adapter for Lisp Package definitions and lifecycle receipts | provides `ctx.lispRuntimeRunner` |
